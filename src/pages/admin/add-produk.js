...
export default function renderAddProdukAdmin() {
  return `
  <section class="bg-[#fdfcfb] min-h-screen flex flex-col">
    ...
    <div class="flex flex-1">
      ...
      <main class="flex-1 p-10">
        <h2 class="text-3xl font-bold text-sky-600 mb-4">Tambah Produk Baru</h2>
        <p class="text-gray-700 mb-10">Isi detail produk tekstil baru yang ingin Anda tambahkan ke sistem.</p>
        ...
        <form class="form-addProduk bg-white p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.25)] max-w-2xl">
          ...
          <div class="grid sm:grid-cols-2 gap-6 mb-5">
            <div>
              ...
              <input type="number" id="harga" name="harga" placeholder="Contoh: 75000"
                class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500" />
            </div>
            <div>
              <label class="block text-gray-700 font-semibold mb-2" for="stok">Stok</label>
              <input type="number" id="stok" name="stok" placeholder="Contoh: 100"
                class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500" />
            </div>
          </div>
          ...
          <div class="mb-5">
            ...
            <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Tulis deskripsi produk..."
              class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500"></textarea>
          </div>
